...
import LapApplicationInfoStep from "./loan-steps/LapApplicationInfoStep";
...
import LapReferencesAndDocumentsStep from "./loan-steps/LapReferencesAndDocumentsStep";
import DeclarationStep from "./loan-steps/DeclarationStep";

interface LapLoanApplicationFormProps {
...
const LapProductStepWrapper = ({ data, onChange, ...rest }: any) => {
  return <LapProductStep {...rest} data={data} onChange={onChange} />;
};

const ReferencesStepWrapper = (props: any) => {
  return <LapReferencesAndDocumentsStep {...props} mode="references" />;
};

const DocumentsStepWrapper = (props: any) => {
  return <LapReferencesAndDocumentsStep {...props} mode="documents" />;
};

export default function LapLoanApplicationForm({
  applicationId,
  initialData,
  onSuccess,
  initialLoanType = "PERSONAL_LOAN",
}: LapLoanApplicationFormProps) {
  ...
  const baseSteps = [
    { id: 1, title: "Setup & Sourcing", component: LapApplicationInfoStep },
      ...
      : []),
    {
      ...
      component: LapProductStepWrapper,
    },
    {
        ...
        <div className="flex gap-2">
          ...
          {currentStep === steps.length ? (
            ...
            >
              ...
              {loading ? "Submitting..." : "Submit LAP Application"}
            </button>
          ) : (
            <button
