...
export default function LASBusinessApplicationPage() {
      ...
      <div className="flex-1 flex flex-col h-full bg-white dark:bg-slate-950 overflow-y-auto">
        <div className="flex-1 flex items-center justify-center p-6">
          <div className="max-w-md w-full text-center">
            ...
            <h2 className="text-2xl font-bold text-gray-900 dark:text-slate-100 mb-2">LAS Business Application Submitted!</h2>
            <p className="text-gray-600 dark:text-slate-400 mb-6">Your Loan Against Securities application for your business has been submitted and is under review.</p>
    ...
    <div className="flex-1 flex flex-col h-full bg-slate-50 dark:bg-slate-900 overflow-y-auto">
      <div className="bg-white dark:bg-slate-900 border-b border-gray-200 dark:border-slate-800 px-4 py-2 shrink-0 flex justify-between items-center">
        <div>
          ...
          <h1 className="text-lg font-bold tracking-tight text-gray-900 dark:text-slate-100">Loan Against Securities</h1>
          <p className="text-xs text-gray-500 dark:text-slate-400 mt-0.5">Complete all steps to apply for a business loan against your company's securities collateral.</p>
        </div>
        <div>
